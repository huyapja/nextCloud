		...
		<div class="space-y-6">
			...
			<div class="rounded-lg border bg-white shadow-sm">
				<div class="p-4">
					...
					<div v-if="jobsByType.length === 0" class="text-gray-500 text-center py-8">
						No stuck jobs found
					</div>
			...
			<div class="rounded-lg border bg-white shadow-sm">
				<div class="p-4">
					...
					<div v-if="jobsByServer.length === 0" class="text-gray-500 text-center py-8">
						No stuck jobs found
					</div>
					<div v-else class="space-y-2">
						<div
			...
			<!-- Long Running Jobs -->
			<div v-if="longRunningJobs.length > 0" class="rounded-lg border bg-white shadow-sm">
				<div class="p-4">
					<h3 class="text-lg font-medium text-gray-900 mb-4">
					...
					<div class="space-y-2">
						<div
							...
							:key="job.name"
							class="flex items-center justify-between p-3 rounded border border-yellow-200 bg-yellow-50"
						>
							<div>
							...
							<Badge :label="job.status" :theme="job.status === 'Running' ? 'yellow' : 'gray'" />
						</div>
					</div>
				</div>
			</div>
